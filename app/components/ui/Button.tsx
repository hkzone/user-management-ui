...
import { focusRing } from '~/utils/rac-utils';
...
let button = tv({
  ...
  variants: {
    variant: {
      primary: cn(
        'inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-colors h-9 px-4 py-2 gap-1 rounded-lg',
        'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ',
        'text-black hover:text-white bg-white hover:bg-black/90 pressed:bg-black border border-black shadow'
      ),
      secondary:
